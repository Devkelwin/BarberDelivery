...
export function ManicureScreen(){
    ...
    return(
        ...
        <Box mx={3} mb={9}>
         ...
         <Center>
              ...
              <Text mt={4} fontFamily={'Tilt'} fontSize={22} color={'black.normal'}>Manicure e Pedicure</Text>
              </Center>
                
            <ServiceCard2 service='Manicure' price='1000 KZ' onPress={() => handleAddToCart('Manicure', 1000)}/>
            <ServiceCard2 service='Pedicure' price='1000 KZ'onPress={() => handleAddToCart('Pedicure', 1000)} />
            <ServiceCard2 service='Pedicure Completo' price='2000 KZ'onPress={() => handleAddToCart('Pedicure Completo', 2000)} />
            <Center>
